...
namespace Cupy
{
    public static partial class cp
    {
        ...
        {
            return a.reshape(new Shape(newshape));
        }
        ...
        {
            return a.amax(axis, @out, keepdims, initial);
        }
        ...
        {
            return empty(new Shape(shape));
        }

        public static NDarray imag(Complex val)
        {
            return asarray(val.Imaginary);
        }
