namespace Cupy
{
    ...
    public static partial class cp
    {
        ...
        {
            return concatenate(new[] { arys.Item1, arys.Item2 }, axis, @out);
        }
        ...
        {
            return concatenate(new[] { arys.Item1, arys.Item2, arys.Item3 }, axis, @out);
        }
        ...
        {
            return concatenate(new[] { arys.Item1, arys.Item2, arys.Item3, arys.Item4 }, axis, @out);
        }
    }
}