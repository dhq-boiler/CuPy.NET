                ...
                case "Boolean[][][][]":
                    {
                        ...
                        for (var i = 0; i < _len; i++)
                        {
                            ...
                            for (var j = 0; j < __len; j++)
                            {
                                ...
                                for (var k = 0; k < ___len; k++)
                                {
                                    _rv[i][j][k] = new Boolean[____len];
                                    for (var l = 0; l < ____len; l++)
                                    {
                                        _rv[i][j][k][l] = (Boolean)ToCsharp<Boolean>(_po[i][j][k][l]);
                                    }
                                }
                            }
                        }
                        ...
                        for (var i = 0; i < _len; i++)
                        {
                            ...
                            for (var j = 0; j < __len; j++)
                            {
                                ...
                                for (var k = 0; k < ___len; k++)
                                {
                                    ...
                                    for (var l = 0; l < ____len; l++)
                                    {
                                        _rv[i][j][k][l] = (Single)ToCsharp<float>(_po[i][j][k][l]);
                                    }
                                }
                            }
                        }
                ...
                case "Double[][][][]":
                    {
                        ...
                        for (var i = 0; i < _len; i++)
                        {
                            ...
                            for (var j = 0; j < __len; j++)
                            {
                                ...
                                for (var k = 0; k < ___len; k++)
                                {
                                    _rv[i][j][k] = new double[____len];
                                    for (var l = 0; l < ____len; l++)
                                    {
                                        _rv[i][j][k][l] = (Double)ToCsharp<Double>(_po[i][j][k][l]);
                                    }
                                }
                            }
                        }
                ...
                case "Complex[][][][]":
                    {
                        ...
                        for (var i = 0; i < _len; i++)
                        {
                            ...
                            for (var j = 0; j < __len; j++)
                            {
                                ...
                                for (var k = 0; k < ___len; k++)
                                {
                                    _rv[i][j][k] = new Complex[____len];
                                    for (var l = 0; l < ____len; l++)
                                    {
                                        _rv[i][j][k][l] = (Complex)ToCsharp<Complex>(_po[i][j][k][l]);
                                    }
                                }
                            }
                        }
