...
namespace Cupy
{
    public static partial class cp
    {
        ...
        public static Dtype bool_
        {
            ...
            set => self.SetAttr("bool_", ToPython(value));
        }
        ...
        public static Dtype bool8
        {
            ...
            set => self.SetAttr("bool8", ToPython(value));
        }
        ...
        public static Dtype @byte
        {
            ...
            set => self.SetAttr("byte", ToPython(value));
        }
        ...
        public static Dtype @short
        {
            ...
            set => self.SetAttr("short", ToPython(value));
        }
        ...
        public static Dtype intc
        {
            ...
            set => self.SetAttr("intc", ToPython(value));
        }
        ...
        public static Dtype int_
        {
            ...
            set => self.SetAttr("int_", ToPython(value));
        }
        ...
        public static Dtype longlong
        {
            ...
            set => self.SetAttr("longlong", ToPython(value));
        }
        ...
        public static Dtype intp
        {
            ...
            set => self.SetAttr("intp", ToPython(value));
        }
        ...
        public static Dtype int8
        {
            ...
            set => self.SetAttr("int8", ToPython(value));
        }
        ...
        public static Dtype int16
        {
            ...
            set => self.SetAttr("int16", ToPython(value));
        }

        public static dynamic Int16(Int64 val)
        {
            return int16.ToPython(val);
        }
        ...
        public static Dtype int32
        {
            ...
            set => self.SetAttr("int32", ToPython(value));
        }

        public static dynamic Int32(Int64 val)
        {
            return int32.ToPython(val);
        }
        ...
        public static Dtype int64
        {
            ...
            set => self.SetAttr("int64", ToPython(value));
        }

        public static dynamic Int64(Int64 val)
        {
            return int64.ToPython(val);
        }
        ...
        public static Dtype ubyte
        {
            ...
            set => self.SetAttr("ubyte", ToPython(value));
        }
        ...
        public static Dtype @ushort
        {
            ...
            set => self.SetAttr("ushort", ToPython(value));
        }
        ...
        public static Dtype uintc
        {
            ...
            set => self.SetAttr("uintc", ToPython(value));
        }
        ...
        public static Dtype @uint
        {
            ...
            set => self.SetAttr("uint", ToPython(value));
        }
        ...
        public static Dtype ulonglong
        {
            ...
            set => self.SetAttr("ulonglong", ToPython(value));
        }
        ...
        public static Dtype uintp
        {
            ...
            set => self.SetAttr("uintp", ToPython(value));
        }
        ...
        public static Dtype uint8
        {
            ...
            set => self.SetAttr("uint8", ToPython(value));
        }
        ...
        public static Dtype uint16
        {
            ...
            set => self.SetAttr("uint16", ToPython(value));
        }
        ...
        public static Dtype uint32
        {
            ...
            set => self.SetAttr("uint32", ToPython(value));
        }
        ...
        public static Dtype uint64
        {
            ...
            set => self.SetAttr("uint64", ToPython(value));
        }
        ...
        public static Dtype half
        {
            ...
            set => self.SetAttr("half", ToPython(value));
        }
        ...
        public static Dtype single
        {
            ...
            set => self.SetAttr("single", ToPython(value));
        }
        ...
        public static Dtype @double
        {
            ...
            set => self.SetAttr("double", ToPython(value));
        }
        ...
        public static Dtype float_
        {
            ...
            set => self.SetAttr("float_", ToPython(value));
        }
        ...
        public static Dtype longfloat
        {
            ...
            set => self.SetAttr("longfloat", ToPython(value));
        }
        ...
        public static Dtype float16
        {
            ...
            set => self.SetAttr("float16", ToPython(value));
        }
        ...
        public static Dtype float32
        {
            ...
            set => self.SetAttr("float32", ToPython(value));
        }
        ...
        public static Dtype float64
        {
            ...
            set => self.SetAttr("float64", ToPython(value));
        }
        ...
        public static Dtype float96
        {
            ...
            set => self.SetAttr("float96", ToPython(value));
        }
        ...
        public static Dtype float128
        {
            ...
            set => self.SetAttr("float128", ToPython(value));
        }
        ...
        public static Dtype csingle
        {
            ...
            set => self.SetAttr("csingle", ToPython(value));
        }
        ...
        public static Dtype complex_
        {
            ...
            set => self.SetAttr("complex_", ToPython(value));
        }
        ...
        public static Dtype clongfloat
        {
            ...
            set => self.SetAttr("clongfloat", ToPython(value));
        }
        ...
        public static Dtype complex64
        {
            ...
            set => self.SetAttr("complex64", ToPython(value));
        }
        ...
        public static Dtype complex128
        {
            ...
            set => self.SetAttr("complex128", ToPython(value));
        }
        ...
        public static Dtype complex192
        {
            ...
            set => self.SetAttr("complex192", ToPython(value));
        }
        ...
        public static Dtype complex256
        {
            ...
            set => self.SetAttr("complex256", ToPython(value));
        }
        ...
        public static Dtype object_
        {
            ...
            set => self.SetAttr("object_", ToPython(value));
        }
        ...
        public static Dtype bytes_
        {
            ...
            set => self.SetAttr("bytes_", ToPython(value));
        }
        ...
        public static Dtype unicode_
        {
            ...
            set => self.SetAttr("unicode_", ToPython(value));
        }
        ...
        public static Dtype @void
        {
            ...
            set => self.SetAttr("void", ToPython(value));
        }
    }
}