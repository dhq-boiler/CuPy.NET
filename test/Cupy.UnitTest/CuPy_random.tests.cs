...
{
    [TestFixture]
    public class Cupy_randomTest : BaseTestCase
    {
        [Test]
        ...
        {
            // >>> cp.random.randint(2, size=10)
            // array([1, 0, 0, 0, 1, 1, 0, 0, 1, 0])
            // >>> cp.random.randint(1, size=10)
        ...
        {
            // >>> cp.random.random_integers(5)
            // 4
            // >>> type(cp.random.random_integers(5))
            // <type 'int'>
            // >>> cp.random.random_integers(5, size=(3,2))
            // array([[5, 4],
            //        [3, 3],
            //        [4, 5]])
            // 
            ...
            // >>> 2.5 * (cp.random.random_integers(5, size=(5,)) - 1) / 4.
            ...
            // >>> d1 = cp.random.random_integers(1, 6, 1000)
            // >>> d2 = cp.random.random_integers(1, 6, 1000)
            // >>> dsums = d1 + d2
            // 

#if TODO
             given = d1 = cp.random.random_integers(1, 6, 1000);
             given = d2 = cp.random.random_integers(1, 6, 1000);
             given = dsums = d1 + d2;
#endif
        ...
        public void random_sampleTest()
        {
            ...
            // 0.47108547995356098
            // >>> type(cp.random.random_sample())
            // <type 'float'>
            // >>> cp.random.random_sample((5,))
            ...
            // >>> 5 * cp.random.random_sample((3, 2)) - 5
...
#if TODO
             given = 5 * cp.random.random_sample((3, 2)) - 5;
             expected =
                "array([[-3.99149989, -0.52338984],\n" +
                "       [-2.99091858, -0.79479508],\n" +
                "       [-1.23204345, -1.75224494]])";
        ...
        {
            // Generate a uniform random sample from cp.arange(5) of size 3:

            // >>> cp.random.choice(5, 3)
            // array([0, 3, 4])
            // >>> #This is equivalent to cp.random.randint(0,5,3)
            // 
            ...
            // >>> cp.random.choice(5, 3, p=[0.1, 0, 0.3, 0.6, 0])
            // array([3, 3, 0])
            // 
            ...
            // >>> cp.random.choice(5, 3, replace=False)
            // array([3,1,0])
            // >>> #This is equivalent to cp.random.permutation(cp.arange(5))[:3]
            // 
            ...
            // >>> cp.random.choice(5, 3, replace=False, p=[0.1, 0, 0.3, 0.6, 0])
            // array([2, 3, 0])
            // 
            ...
            // >>> cp.random.choice(aa_milne_arr, 5, p=[0.5, 0.1, 0.1, 0.3])
            ...
            // 
             ...
             given = cp.random.choice(aa_milne_arr, 5, p = {0.5, 0.1, 0.1, 0.3});
             expected =
                "array(['pooh', 'pooh', 'pooh', 'Christopher', 'piglet'],\n" +
                "      dtype='|S11')";
            Assert.AreEqual(expected, given.repr);
...
#if TODO
            var given = arr = cp.arange(10);
             given = cp.random.shuffle(arr);
             given = arr;
            var expected =
                "[1 7 5 2 9 4 3 6 0 8]";
            Assert.AreEqual(expected, given.repr);
...
#if TODO
             given = arr = cp.arange(9).reshape((3, 3));
             given = cp.random.shuffle(arr);
             given = arr;
             expected =
                "array([[3, 4, 5],\n" +
...
#if TODO
             given = arr = cp.arange(9).reshape((3, 3));
             given = cp.random.permutation(arr);
             expected =
                "array([[6, 7, 8],\n" +
                "       [0, 1, 2],\n" +
                "       [3, 4, 5]])";
        ...
        public void binomialTest()
        {
            ...
            // >>> sum(cp.random.binomial(9, 0.1, 20000) == 0)/20000.
            // # answer = 0.38885, or 38%.
            // 

#if TODO
             given = sum(cp.random.binomial(9, 0.1, 20000) == 0)/20000.;
            // answer = 0.38885, or 38%.
#endif
        }
        ...
        public void dirichletTest()
        {
            ...
            // >>> s = cp.random.dirichlet((10, 5, 3), 20).transpose()
            // 

#if TODO
            var given = s = cp.random.dirichlet((10, 5, 3), 20).transpose();
#endif
            // >>> import matplotlib.pyplot as plt
        ...
        public void gammaTest()
        {
            ...
            // >>> s = cp.random.gamma(shape, scale, 1000)
            // 

#if TODO
            var given = shape, scale = 2., 2.  # mean = 4, std = 2*sqrt(2);
             given = s = cp.random.gamma(shape, scale, 1000);
#endif
            ...
            // >>> y = bins**(shape-1)*(cp.exp(-bins/scale) /
        ...
        public void geometricTest()
        {
            ...
            // >>> z = cp.random.geometric(p=0.35, size=10000)
            // 

#if TODO
            var given = z = cp.random.geometric(p = 0.35, size = 10000);
#endif
        ...
        public void gumbelTest()
        {
            ...
            // >>> s = cp.random.gumbel(mu, beta, 1000)
            // 

#if TODO
            var given = mu, beta = 0, 0.1 # location and scale;
             given = s = cp.random.gumbel(mu, beta, 1000);
#endif
            // Display the histogram of the samples, along with
            // the probability density function:
            ...
            // >>> plt.plot(bins, (1/beta)*cp.exp(-(bins - mu)/beta)
            ...
            // 
             ...
             given = plt.plot(bins, (1/beta)*cp.exp(-(bins - mu)/beta);
            var expected =
                "...          * cp.exp( -cp.exp( -(bins - mu) /beta) ),\n" +
                "...          linewidth=2, color='r')";
            Assert.AreEqual(expected, given.repr);
            ...
            // >>> beta = cp.std(maxima) * cp.sqrt(6) / cp.pi
            // >>> mu = cp.mean(maxima) - 0.57721*beta
            // >>> plt.plot(bins, (1/beta)*cp.exp(-(bins - mu)/beta)
            // ...          * cp.exp(-cp.exp(-(bins - mu)/beta)),
            // ...          linewidth=2, color='r')
            // >>> plt.plot(bins, 1/(beta * cp.sqrt(2 * cp.pi))
        ...
        public void hypergeometricTest()
        {
            ...
            // >>> s = cp.random.hypergeometric(ngood, nbad, nsamp, 1000)
            ...
            // number of good, number of bad, and number of samples
             given = s = cp.random.hypergeometric(ngood, nbad, nsamp, 1000);
            ...
            // >>> s = cp.random.hypergeometric(15, 15, 15, 100000)
            // >>> sum(s>=12)/100000. + sum(s<=3)/100000.
            // #   answer = 0.003 ... pretty unlikely!
            // 

#if TODO
             given = s = cp.random.hypergeometric(15, 15, 15, 100000);
        ...
        public void laplaceTest()
        {
            ...
            // >>> loc, scale = 0., 1.
            // >>> s = cp.random.laplace(loc, scale, 1000)
            // 

#if TODO
            var given = loc, scale = 0., 1.;
             given = s = cp.random.laplace(loc, scale, 1000);
#endif
            // Display the histogram of the samples, along with
            // the probability density function:
            ...
            // >>> count, bins, ignored = plt.hist(s, 30, density=True)
            // >>> x = cp.arange(-8., 8., .01)
            // >>> pdf = cp.exp(-abs(x-loc)/scale)/(2.*scale)
            // >>> plt.plot(x, pdf)
            // 
             ...
             given = import matplotlib.pyplot as plt;
             given = count, bins, ignored = plt.hist(s, 30, density = True);
             given = x = cp.arange(-8., 8., .01);
             given = pdf = cp.exp(-abs(x-loc)/scale)/(2.*scale);
             given = plt.plot(x, pdf);
#endif
            // Plot Gaussian for comparison:

            // >>> g = (1/(scale * cp.sqrt(2 * cp.pi)) *
        ...
        public void logisticTest()
        {
            ...
            // >>> loc, scale = 10, 1
            // >>> s = cp.random.logistic(loc, scale, 10000)
            // >>> import matplotlib.pyplot as plt
            ...
            var given = loc, scale = 10, 1;
             given = s = cp.random.logistic(loc, scale, 10000);
             given = import matplotlib.pyplot as plt;
        ...
        public void lognormalTest()
        {
            ...
            // >>> s = cp.random.lognormal(mu, sigma, 1000)
            // 

#if TODO
            var given = mu, sigma = 3., 1. # mean and standard deviation;
             given = s = cp.random.lognormal(mu, sigma, 1000);
#endif
            // Display the histogram of the samples, along with
            // the probability density function:
...
#endif
            // >>> x = cp.linspace(min(bins), max(bins), 10000)
            // >>> pdf = (cp.exp(-(cp.log(x) - mu)**2 / (2 * sigma**2))
            // ...        / (x * sigma * cp.sqrt(2 * cp.pi)))
            // 

#if TODO
             given = x = cp.linspace(min(bins), max(bins), 10000);
            ...
            // >>> sigma = cp.std(cp.log(b))
            // >>> mu = cp.mean(cp.log(b))
            // 

#if TODO
             given = b = cp.array(b) / cp.min(b) # scale values to be positive;
             given = count, bins, ignored = plt.hist(b, 100, density = True, align = 'mid');
             given = sigma = cp.std(cp.log(b));
             given = mu = cp.mean(cp.log(b));
#endif
            // >>> x = cp.linspace(min(bins), max(bins), 10000)
            // >>> pdf = (cp.exp(-(cp.log(x) - mu)**2 / (2 * sigma**2))
            // ...        / (x * sigma * cp.sqrt(2 * cp.pi)))
...
#if TODO
            var given = a = .6;
             given = s = cp.random.logseries(a, 10000);
             given = import matplotlib.pyplot as plt;
        ...
        public void multinomialTest()
        {
            ...
            // >>> cp.random.multinomial(20, [1/6.]*6, size=1)
            // array([[4, 1, 7, 5, 2, 1]])
            // 
            ...
            // >>> cp.random.multinomial(20, [1/6.]*6, size=2)
            // array([[3, 4, 3, 3, 4, 3],
            //        [2, 4, 3, 4, 0, 7]])
            // 

#if TODO
             given = cp.random.multinomial(20, {1/6.}*6, size = 2);
             expected =
                "array([[3, 4, 3, 3, 4, 3],\n" +
                "       [2, 4, 3, 4, 0, 7]])";
            Assert.AreEqual(expected, given.repr);
            ...
            // >>> cp.random.multinomial(100, [1/7.]*5 + [2/7.])
            ...
            // >>> cp.random.multinomial(100, [1.0 / 3, 2.0 / 3])  # RIGHT
            // array([38, 62])
            // 
            ...
            // >>> cp.random.multinomial(100, [1.0, 2.0])  # WRONG
            // array([100,   0])
            // 
        ...
        public void multivariate_normalTest()
        {
            // >>> mean = (1, 2)
            // >>> cov = [[1, 0], [0, 1]]
            // >>> x = cp.random.multivariate_normal(mean, cov, (3, 3))
            // >>> x.shape
            // (3, 3, 2)
            // 
            ...
            var given = mean = (1, 2);
             given = cov = [[1, 0], [0, 1]];
             given = x = cp.random.multivariate_normal(mean, cov, (3, 3));
             given = x.shape;
            var expected =
                "(3, 3, 2)";
            Assert.AreEqual(expected, given.repr);
        ...
        public void negative_binomialTest()
        {
            ...
            // >>> s = cp.random.negative_binomial(1, 0.1, 100000)
            // >>> for i in range(1, 11):
...
#if TODO
            var given = s = cp.random.negative_binomial(1, 0.1, 100000);
        ...
        public void noncentral_chisquareTest()
        {
            ...
            // >>> import matplotlib.pyplot as plt
            // >>> values = plt.hist(cp.random.noncentral_chisquare(3, 20, 100000),
            ...
            // >>> plt.figure()
            // >>> values = plt.hist(cp.random.noncentral_chisquare(3, .0000001, 100000),
            // ...                   bins=cp.arange(0., 25, .1), density=True)
            // >>> values2 = plt.hist(cp.random.chisquare(3, 100000),
            // ...                    bins=cp.arange(0., 25, .1), density=True)
        ...
        public void noncentral_fTest()
        {
            ...
            // >>> nonc = 3.0
            // >>> nc_vals = cp.random.noncentral_f(dfnum, dfden, nonc, 1000000)
            // >>> NF = cp.histogram(nc_vals, bins=50, density=True)
            // >>> c_vals = cp.random.f(dfnum, dfden, 1000000)
            // >>> F = cp.histogram(c_vals, bins=50, density=True)
            // >>> import matplotlib.pyplot as plt
            // >>> plt.plot(F[1][1:], F[0])
            ...
            var given = dfnum = 3 # between group deg of freedom;
             ...
             given = nonc = 3.0;
             given = nc_vals = cp.random.noncentral_f(dfnum, dfden, nonc, 1000000);
             given = NF = cp.histogram(nc_vals, bins = 50, density = True);
             given = c_vals = cp.random.f(dfnum, dfden, 1000000);
             given = F = cp.histogram(c_vals, bins = 50, density = True);
             given = import matplotlib.pyplot as plt;
        ...
        public void normalTest()
        {
            ...
            // >>> s = cp.random.normal(mu, sigma, 1000)
            // 
            var (mu, sigma) = (0.0f, 0.1f); // mean and standard deviation;
            var s = cp.random.normal(mu, sigma, 1000);
            ...
            // >>> cp.random.normal(3, 2.5, size = (2, 4))
            // array([[-4.49401501, 4.00950034, -1.81814867, 7.29718677],   # random
            //    [ 0.39924804,  4.68456316,  4.99394529,  4.84057254]])  # random
        ...
        public void paretoTest()
        {
            ...
            // >>> s = (cp.random.pareto(a, 1000) + 1) * m
            // 

#if TODO
            var given = a, m = 3., 2.  # shape and mode;
             given = s = (cp.random.pareto(a, 1000) + 1) * m;
#endif
        ...
        public void poissonTest()
        {
            ...
            // >>> import Cupy as np
            // >>> s = cp.random.poisson(5, 10000)
            // 

#if TODO
            var given = import Cupy as np;
             given = s = cp.random.poisson(5, 10000);
#endif
            ...
            // >>> s = cp.random.poisson(lam=(100., 500.), size=(100, 2))
            // 

#if TODO
             given = s = cp.random.poisson(lam = (100., 500.), size = (100, 2));
#endif
        }
        ...
        public void rayleighTest()
        {
            ...
            // >>> from matplotlib.pyplot import hist
            // >>> values = hist(cp.random.rayleigh(3, 100000), bins=200, density=True)
            // 

#if TODO
            var given = from matplotlib.pyplot import hist;
             given = values = hist(cp.random.rayleigh(3, 100000), bins = 200, density = True);
#endif
            ...
            // >>> meanvalue = 1
            // >>> modevalue = cp.sqrt(2 / cp.pi) * meanvalue
            // >>> s = cp.random.rayleigh(modevalue, 1000000)
            // 

#if TODO
             given = meanvalue = 1;
             given = modevalue = cp.sqrt(2 / cp.pi) * meanvalue;
             given = s = cp.random.rayleigh(modevalue, 1000000);
#endif
        ...
        public void standard_cauchyTest()
        {
            ...
            // >>> import matplotlib.pyplot as plt
            // >>> s = cp.random.standard_cauchy(1000000)
...
#if TODO
            var given = import matplotlib.pyplot as plt;
             given = s = cp.random.standard_cauchy(1000000);
        ...
        public void standard_exponentialTest()
        {
            ...
            // >>> n = cp.random.standard_exponential((3, 8000))
            // 

#if TODO
            var given = n = cp.random.standard_exponential((3, 8000));
#endif
        }
        ...
        public void standard_gammaTest()
        {
            ...
            // >>> s = cp.random.standard_gamma(shape, 1000000)
            // 

#if TODO
            var given = shape, scale = 2., 1. # mean and width;
             given = s = cp.random.standard_gamma(shape, 1000000);
#endif
            // Display the histogram of the samples, along with
            // the probability density function:
        ...
        {
            // >>> s = cp.random.standard_normal(8000)
            // >>> s
            // array([ 0.6888893 ,  0.78096262, -0.89086505, ...,  0.49876311, #random
            //        -0.38672696, -0.4685006 ])                               #random
            // >>> s.shape
            // (8000,)
            // >>> s = cp.random.standard_normal(size=(3, 4, 2))
            // >>> s.shape
            // (3, 4, 2)
            // 

#if TODO
            var given = s = cp.random.standard_normal(8000);
             given = s;
            var expected =
                "array([ 0.6888893 ,  0.78096262, -0.89086505, ...,  0.49876311, #random\n" +
                "       -0.38672696, -0.4685006 ])                               #random";
        ...
        public void standard_tTest()
        {
            ...
            // >>> intake = cp.array([5260., 5470, 5640, 6180, 6390, 6515, 6805, 7515, \
            // ...                    7515, 8230, 8770])
            // 
            ...
            // >>> s = cp.random.standard_t(10, size=100000)
            // >>> cp.mean(intake)
            // 6753.636363636364
            // >>> intake.std(ddof=1)
            // 1142.1232221373727
...
#if TODO
             given = s = cp.random.standard_t(10, size = 100000);
            ...
            // >>> t = (cp.mean(intake)-7725)/(intake.std(ddof=1)/cp.sqrt(len(intake)))
            // >>> import matplotlib.pyplot as plt
            // >>> h = plt.hist(s, bins=100, density=True)
            // 

#if TODO
             given = t = (cp.mean(intake)-7725)/(intake.std(ddof = 1)/cp.sqrt(len(intake)));
             given = import matplotlib.pyplot as plt;
        ...
        public void triangularTest()
        {
            ...
            // >>> import matplotlib.pyplot as plt
            // >>> h = plt.hist(cp.random.triangular(-3, 0, 8, 100000), bins=200,
            // ...              density=True)
            // >>> plt.show()
            // 
        ...
        public void uniformTest()
        {
            ...
            // >>> s = cp.random.uniform(-1,0,1000)
            // 

#if TODO
            var given = s = cp.random.uniform(-1,0,1000);
#endif
            ...
            // >>> plt.plot(bins, cp.ones_like(bins), linewidth=2, color='r')
            // >>> plt.show()
            // 
             ...
             given = plt.plot(bins, cp.ones_like(bins), linewidth = 2, color = 'r');
             given = plt.show();
#endif
        }
        ...
        public void vonmisesTest()
        {
            ...
            // >>> s = cp.random.vonmises(mu, kappa, 1000)
            // 

#if TODO
            var given = mu, kappa = 0.0, 4.0 # mean and dispersion;
             given = s = cp.random.vonmises(mu, kappa, 1000);
#endif
            // Display the histogram of the samples, along with
            // the probability density function:
            ...
            // >>> x = cp.linspace(-cp.pi, cp.pi, num=51)
            // >>> y = cp.exp(kappa*cp.cos(x-mu))/(2*cp.pi*i0(kappa))
            ...
            // 
             ...
             given = x = cp.linspace(-cp.pi, cp.pi, num = 51);
             given = y = cp.exp(kappa*cp.cos(x-mu))/(2*cp.pi*i0(kappa));
        ...
        public void waldTest()
        {
            ...
            // >>> import matplotlib.pyplot as plt
            // >>> h = plt.hist(cp.random.wald(3, 2, 100000), bins=200, density=True)
            // >>> plt.show()
            // 

#if TODO
            var given = import matplotlib.pyplot as plt;
             given = h = plt.hist(cp.random.wald(3, 2, 100000), bins = 200, density = True);
             given = plt.show();
#endif
        }
        ...
        public void weibullTest()
        {
            ...
            // >>> a = 5. # shape
            // >>> s = cp.random.weibull(a, 1000)
            // 

#if TODO
            var given = a = 5. # shape;
             given = s = cp.random.weibull(a, 1000);
#endif
            // Display the histogram of the samples, along with
            // the probability density function:
...
#if TODO
             given = count, bins, ignored = plt.hist(cp.random.weibull(5.,1000));
             given = x = cp.arange(1,100.)/50.;
        ...
        public void zipfTest()
        {
            ...
            // >>> a = 2. # parameter
            // >>> s = cp.random.zipf(a, 1000)
            // 

#if TODO
            var given = a = 2. # parameter;
             given = s = cp.random.zipf(a, 1000);
#endif
            // Display the histogram of the samples, along with
            // the probability density function:
